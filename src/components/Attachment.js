                                        ...
                                        <td className="px-4 py-3">
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 truncate max-w-[200px]" title={doc.description}>
                                                        {doc.description}
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">
                                            {selectedDocument.category} • {selectedDocument.size} • {selectedDocument.uploadedBy}
                                        </p>
                                    </div>
                                </div>
