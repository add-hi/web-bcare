        ...
        submenu: [
            {
                ...
                hasSubSubmenu: true,
                subSubmenu: [
                    { name: "Inquiry", href: "/dashboard/request/banking/inquiry", icon: Search },
                    { name: "Maintain", href: "/dashboard/request/banking/maintain", icon: Settings },
                    { name: "Transaction", href: "/dashboard/request/banking/transaction", icon: TrendingUp },
                    { name: "Complaint", href: "/dashboard/request/banking/complaint", icon: MessageSquare },
                    { name: "Monitoring", href: "/dashboard/request/banking/monitoring", icon: Monitor },
                ]
            },
            { name: "Kartu Kredit", href: "/dashboard/request/cc", icon: CreditCard },
            { name: "Trade & Remittance", href: "/dashboard/request/tnc", icon: Plus },
            { name: "Service Action Team", href: "/dashboard/request/sat", icon: Plus },
                                                        ...
                                                        <div>
                                                            ...
                                                            {subItem.hasSubSubmenu ? (
                                                                ...
                                                                >
                                                                    ...
                                                                    <ChevronRight
                                                                        size={14}
                                                                        className={`transition-transform duration-200 ${expandedSubMenus[subItem.name] ? "rotate-90" : ""
                                                                            }`}
                                                                    />
                                                                </div>
                                                            ) : (
                                                            ...
                                                            {/* Sub-submenu */}
                                                            {subItem.hasSubSubmenu && expandedSubMenus[subItem.name] && (
                                                                <ul className="mt-2 ml-6 space-y-1">
