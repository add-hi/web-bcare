...
export default function useAddComplaint() {
  ...
  const saveTicket = useCallback(async () => {
    ...
    console.log('   - dataFormData exists:', !!dataFormData);
    console.log('   - actionFormData exists:', !!actionFormData);
    ...
    try {
      ...
      console.log('🔍 ACCOUNT/CARD LOOKUP DEBUG:');
      console.log('   - customerData?.accountNumber:', customerData?.accountNumber);
      console.log('   - customerData?.cardNumber:', customerData?.cardNumber);
      
      alert(`DEBUG: Account=${customerData?.accountNumber}, Card=${customerData?.cardNumber}`);
